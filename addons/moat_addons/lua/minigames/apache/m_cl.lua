...
local function moat_InitDrawBossHealth()
	...
	sound.PlayURL("http://moatgaming.net/ttt/apache/american_music.mp3", "mono", function(siren)
...
local function moat_PrepareBoss()
	...
	sound.PlayURL("http://moatgaming.net/ttt/apache/apache1smith.mp3", "mono", function(siren)
		if(IsValid(siren))then
			siren:SetVolume(2)
			siren:Play()
		else
