...
_SCF('moat_ChatFont', lato(2, 16))
_SCF('moat_MenuFont', {font = 'Lato Bold',size = 15,weight = 800})

_SCF('TabLarge', {font = 'Lato',size = 13,weight = 900, shadow=true, antialias=true})
...
_SCF('TargetIDSmall2', {font = df,size = 16,weight = 1000, shadow=true,antialias=true})
