...
moat_blush = Color(103, 152, 235, 255)
moat_blue = Color(94, 114, 228, 255)
moat_lime = Color(0, 255, 0, 255)
moat_green = Color(45, 206, 137, 255)
moat_red = Color(245, 54, 92, 255)
moat_orange = Color(251, 99, 64, 255)
moat_indigo = Color(86, 3, 173, 255)
moat_purple = Color(137, 101, 224, 255)
moat_pink = Color(243, 164, 181, 255)
moat_yellow = Color(255, 214, 0, 255)
moat_teal = Color(17, 205, 239, 255)
moat_cyan = Color(43, 255, 198, 255)
