-- Use gm_hash if we have it since it's a faster https://github.com/SuperiorServers/gm_hash
if (SERVER) and file.Exists("lua/bin/gmsv_hash_" .. (system.IsWindows() and "win32" or "linux") .. ".dll", "MOD") then
    _require"hash"
...
local function str2hexa(s)
    return string_gsub(s, ".", function(c) return string_format("%02x", string_byte(c)) end)
end
