-- Generated from: glib/lua/glib/databases/mysqloodatabase.lua
-- Original:       https://github.com/notcake/glib/blob/master/lua/glib/databases/mysqloodatabase.lua
-- Timestamp:      2016-02-22 19:22:23
-- MySQLOO
local self = {}
CAC.Databases.MySqlOODatabase = CAC.MakeConstructor (self, CAC.Databases.IDatabase)
...
function self:Connect (server, port, username, password, databaseName, callback)
	if not callback then return I (CAC.CallSelfAsAsync ()) end
