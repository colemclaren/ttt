-- Generated from: glib/lua/glib/parsing/durationparser.lua
-- Original:       https://github.com/notcake/glib/blob/master/lua/glib/parsing/durationparser.lua
-- Timestamp:      2016-02-22 19:22:23
local self = {}
CAC.DurationParser = CAC.MakeConstructor (self, CAC.StringParser)

local string_lower = string.lower

function CAC.DurationParser.Parse (str)
	local parser = CAC.DurationParser (str)
...
local siPrefixes =
{
	...
	{ Prefix = "micro", Abbreviation = CAC.UTF8.Char (0x03BC), Multiplier = 1e-6 },
