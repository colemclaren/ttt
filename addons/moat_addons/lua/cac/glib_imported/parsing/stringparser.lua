-- Generated from: glib/lua/glib/parsing/stringparser.lua
-- Original:       https://github.com/notcake/glib/blob/master/lua/glib/parsing/stringparser.lua
-- Timestamp:      2016-02-22 19:22:23
local self = {}
CAC.StringParser = CAC.MakeConstructor (self)
