-- Generated from: glib/lua/glib/oop/oop.lua
-- Original:       https://github.com/notcake/glib/blob/master/lua/glib/oop/oop.lua
...
function CAC.CreateStaticTable (ictor, out)
...
function CAC.GetMetaTable (typeConstructor)
	if CAC.IsStaticTable (typeConstructor) and
...
function CAC.IsStaticTable (t)
	if not t then return false end
	return rawget (t, "__static") == true
end

--[[
	CAC.MakeConstructor (metatable, base, base2)
		Returns: () -> Object
...
function CAC.MakeConstructor (metatable, base, ...)
	metatable.__index       = metatable
	
	-- Inheritance
	local statictable = CAC.CreateStaticTable ()
	local typeinfo = {}
	...
	if base then
		-- 1st base class
		local basetable = CAC.GetMetaTable (base)
