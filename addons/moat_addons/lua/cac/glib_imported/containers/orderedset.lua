-- Generated from: glib/lua/glib/containers/orderedset.lua
-- Original:       https://github.com/notcake/glib/blob/master/lua/glib/containers/orderedset.lua
-- Timestamp:      2016-02-22 19:22:23
local self = {}
CAC.Containers.OrderedSet = CAC.MakeConstructor (self, CAC.Containers.ICollection)
...
function self:ToString ()
	...
	for item in self:GetEnumerator () do
		...
		elseif type (item) == "string" then item = "\"" .. CAC.String.Escape (item) .. "\"" end
		item = tostring (item)
