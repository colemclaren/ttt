-- Generated from: glib/lua/glib/io/outbuffer.lua
-- Original:       https://github.com/notcake/glib/blob/master/lua/glib/io/outbuffer.lua
-- Timestamp:      2016-02-22 19:22:23
local self = {}
CAC.OutBuffer = CAC.MakeConstructor (self)
...
function self:Clear ()
	CAC.Error ("OutBuffer:Clear : Not implemented.")
end

function self:GetSize ()
	CAC.Error ("OutBuffer:GetSize : Not implemented.")
end

function self:GetString ()
	CAC.Error ("OutBuffer:GetString : Not implemented.")
end

function self:UInt8 (n)
	CAC.Error ("OutBuffer:UInt8 : Not implemented.")
end
...
function self:Int8 (n)
	CAC.Error ("OutBuffer:Int8 : Not implemented.")
end
...
function self:Float (f)
	local n = CAC.BitConverter.FloatToUInt32 (f)
	self:UInt32 (n)
end

function self:Double (f)
	local low, high = CAC.BitConverter.DoubleToUInt32s (f)
	self:UInt32 (low)
	self:UInt32 (high)
end
...
function self:String (data)
	CAC.Error ("OutBuffer:String : Not implemented.")
end
