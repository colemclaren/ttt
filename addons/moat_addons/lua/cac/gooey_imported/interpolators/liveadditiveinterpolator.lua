-- Generated from: gooey/lua/gooey/interpolators/liveadditiveinterpolator.lua
-- Original:       https://github.com/notcake/gooey/blob/master/lua/gooey/interpolators/liveadditiveinterpolator.lua
-- Timestamp:      2016-04-28 19:58:52
local self = {}
CAC.LiveAdditiveInterpolator = CAC.MakeConstructor (self, CAC.TimeInterpolator)
...
function self:HookTickController (tickController)
	...
	tickController:AddEventListener ("Tick", "CAC.LiveAdditiveInterpolator." .. self:GetHashCode (),
		function ()
			self:Tick ()
		end
	)
...
function self:UnhookTickController (tickController)
	...
	tickController:RemoveEventListener ("Tick", "CAC.LiveAdditiveInterpolator." .. self:GetHashCode ())
end