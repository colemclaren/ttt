-- Generated from: gooey/lua/gooey/ui/selectioncontroller.lua
-- Original:       https://github.com/notcake/gooey/blob/master/lua/gooey/ui/selectioncontroller.lua
-- Timestamp:      2016-04-28 19:58:52
local self = {}
CAC.SelectionController = CAC.MakeConstructor (self)
...
local SelectionMode = CAC.SelectionMode
...
function self:ctor (control)
	...
	self.SelectionMode   = CAC.SelectionMode.Multiple
	...
	control:AddEventListener ("MouseDown", "CAC.SelectionController." .. self:GetHashCode (), function (_, mouseCode, x, y) self:MouseDown (_, mouseCode, x, y) end)
	control:AddEventListener ("MouseUp",   "CAC.SelectionController." .. self:GetHashCode (), function (_, mouseCode, x, y) self:MouseUp   (_, mouseCode, x, y) end)
	control:AddEventListener ("MouseMove", "CAC.SelectionController." .. self:GetHashCode (), function (_, mouseCode, x, y) self:MouseMove (_, mouseCode, x, y) end)
end
...
function self:GetSelectionEnumerator ()
	return CAC.ValueEnumerator (self.SelectedItems)
end
