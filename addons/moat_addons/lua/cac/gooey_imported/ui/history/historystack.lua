-- Generated from: gooey/lua/gooey/ui/history/historystack.lua
-- Original:       https://github.com/notcake/gooey/blob/master/lua/gooey/ui/history/historystack.lua
-- Timestamp:      2016-04-28 19:58:52
local self = {}
CAC.HistoryStack = CAC.MakeConstructor (self, CAC.IHistoryStack)
...
function self:ctor ()
	self.PreviousStack = CAC.Containers.Stack ()
	self.NextStack     = CAC.Containers.Stack ()
