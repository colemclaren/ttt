-- Generated from: gooey/lua/gooey/ui/buttoncontroller.lua
-- Original:       https://github.com/notcake/gooey/blob/master/lua/gooey/ui/buttoncontroller.lua
-- Timestamp:      2016-04-28 19:58:52
local self = {}
CAC.ButtonController = CAC.MakeConstructor (self)
