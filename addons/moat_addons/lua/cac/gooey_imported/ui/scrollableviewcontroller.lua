-- Generated from: gooey/lua/gooey/ui/scrollableviewcontroller.lua
-- Original:       https://github.com/notcake/gooey/blob/master/lua/gooey/ui/scrollableviewcontroller.lua
-- Timestamp:      2016-04-28 19:58:52
local self = {}
CAC.ScrollableViewController = CAC.MakeConstructor (self)
...
function self:HookHorizontalScrollBar (horizontalScrollBar)
	...
	horizontalScrollBar:AddEventListener ("InterpolatedScroll", "CAC.ScrollableViewController." .. self:GetHashCode (),
	...
	horizontalScrollBar:AddEventListener ("Removed", "CAC.ScrollableViewController." .. self:GetHashCode (),
		function (_)
			self:SetHorizontalScrollBar (nil)
		end
	)
	horizontalScrollBar:AddEventListener ("Scroll", "CAC.ScrollableViewController." .. self:GetHashCode (),
		function (_, viewX)
...
function self:UnhookHorizontalScrollBar (horizontalScrollBar)
	...
	horizontalScrollBar:RemoveEventListener ("InterpolatedScroll", "CAC.ScrollableViewController." .. self:GetHashCode ())
	horizontalScrollBar:RemoveEventListener ("Removed",            "CAC.ScrollableViewController." .. self:GetHashCode ())
	horizontalScrollBar:RemoveEventListener ("Scroll",             "CAC.ScrollableViewController." .. self:GetHashCode ())
end

function self:HookVerticalScrollBar (verticalScrollBar)
	if not verticalScrollBar then return end
	
	verticalScrollBar:AddEventListener ("InterpolatedScroll", "CAC.ScrollableViewController." .. self:GetHashCode (),
	...
	verticalScrollBar:AddEventListener ("Removed", "CAC.ScrollableViewController." .. self:GetHashCode (),
		function (_)
			self:SetVerticalScrollBar (nil)
		end
	)
	verticalScrollBar:AddEventListener ("Scroll", "CAC.ScrollableViewController." .. self:GetHashCode (),
		function (_, viewY)
...
function self:UnhookVerticalScrollBar (verticalScrollBar)
	...
	verticalScrollBar:RemoveEventListener ("InterpolatedScroll", "CAC.ScrollableViewController." .. self:GetHashCode ())
	verticalScrollBar:RemoveEventListener ("Removed",            "CAC.ScrollableViewController." .. self:GetHashCode ())
	verticalScrollBar:RemoveEventListener ("Scroll",             "CAC.ScrollableViewController." .. self:GetHashCode ())
end
