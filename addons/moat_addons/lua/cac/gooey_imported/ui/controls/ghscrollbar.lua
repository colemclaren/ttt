-- Generated from: gooey/lua/gooey/ui/controls/ghscrollbar.lua
-- Original:       https://github.com/notcake/gooey/blob/master/lua/gooey/ui/controls/ghscrollbar.lua
...
function PANEL:GetOrientation ()
	return CAC.Orientation.Horizontal
end
...
CAC.Register ("GHScrollBar", PANEL, "GBaseScrollBar")