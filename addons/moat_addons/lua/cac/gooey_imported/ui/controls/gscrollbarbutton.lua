-- Generated from: gooey/lua/gooey/ui/controls/gscrollbarbutton.lua
-- Original:       https://github.com/notcake/gooey/blob/master/lua/gooey/ui/controls/gscrollbarbutton.lua
...
CAC.Register ("GScrollBarButton", PANEL, "GButton")