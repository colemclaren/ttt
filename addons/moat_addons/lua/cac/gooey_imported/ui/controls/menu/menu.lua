-- Generated from: gooey/lua/gooey/ui/controls/menu/menu.lua
-- Original:       https://github.com/notcake/gooey/blob/master/lua/gooey/ui/controls/menu/menu.lua
-- Timestamp:      2016-04-28 19:58:53
local self = {}
CAC.Menu = CAC.MakeConstructor (self)
...
function self:AddSeparator (id)
	local menuItem = CAC.MenuSeparator ()
	menuItem:SetId (id)
...
function self:Show (control, ...)
	...
	local w = 0
	local h = 0
	local anchorOrientation = CAC.Orientation.Vertical
...
function self:HookItem (menuItem)
	...
	menuItem:AddEventListener ("Removed", "CAC.Menu." .. self:GetHashCode (),
		function ()
...
function self:UnhookItem (menuItem)
	...
	menuItem:RemoveEventListener ("Removed", "CAC.Menu." .. self:GetHashCode ())
end