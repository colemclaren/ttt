-- Generated from: gooey/lua/gooey/ui/controls/gbasescrollbar.lua
-- Original:       https://github.com/notcake/gooey/blob/master/lua/gooey/ui/controls/gbasescrollbar.lua
...
function PANEL:Init ()
	...
	self.LiveSmoothingInterpolator = CAC.LiveSmoothingInterpolator ()
...
function PANEL:GetOrientation ()
	CAC.Error (self.ClassName .. ":GetOrientation : Not implemented.")
end
...
function PANEL:GetThickness ()
	CAC.Error (self.ClassName .. ":GetThickness : Not implemented.")
end

function PANEL:GetTrackSize ()
	CAC.Error (self.ClassName .. ":GetTraceSize : Not implemented.")
end
...
function PANEL:Think ()
	if self:IsPressed () then
		if SysTime () >= self.NextMouseScrollTime then
			...
			if self:GetOrientation () == CAC.Orientation.Horizontal then
				self:ScrollToMouse (x)
			elseif self:GetOrientation () == CAC.Orientation.Vertical then
...
CAC.Register ("GBaseScrollBar", PANEL, "GPanel")