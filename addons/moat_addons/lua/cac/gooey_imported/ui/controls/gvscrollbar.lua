-- Generated from: gooey/lua/gooey/ui/controls/gvscrollbar.lua
-- Original:       https://github.com/notcake/gooey/blob/master/lua/gooey/ui/controls/gvscrollbar.lua
...
function PANEL:GetOrientation ()
	return CAC.Orientation.Vertical
end
...
CAC.Register ("GVScrollBar", PANEL, "GBaseScrollBar")