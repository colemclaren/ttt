-- Generated from: gooey/lua/gooey/ui/controls/gbutton.lua
-- Original:       https://github.com/notcake/gooey/blob/master/lua/gooey/ui/controls/gbutton.lua
...
CAC.Register ("GButton", PANEL, "DButton")