-- Generated from: gooey/lua/gooey/ui/imagecacheentry.lua
-- Original:       https://github.com/notcake/gooey/blob/master/lua/gooey/ui/imagecacheentry.lua
-- Timestamp:      2016-04-28 19:58:52
local self = {}
CAC.ImageCacheEntry = CAC.MakeConstructor (self)
