-- Generated from: glib/lua/glib/lua/decompiler/framevariable.lua
-- Original:       https://github.com/notcake/glib/blob/master/lua/glib/lua/decompiler/framevariable.lua
-- Timestamp:      2015-08-02 20:22:05
local self = {}
CAC.Lua.FrameVariable = CAC.MakeConstructor (self)
...
function self:AddStore (instructionId, expression, expressionPrecedence, expressionRawValue)
	...
	self.LoadStoreExpressionPrecedences [self.LoadStoreCount] = expressionPrecedence or CAC.Lua.Precedence.Lowest
...
function self:GetLoadStore (id, loadStore)
	...
	loadStore = loadStore or CAC.Lua.LoadStore (self)
...
function self:SetName (name)
	...
	if name and not CAC.Lua.IsValidVariableName (name) and name ~= "..." then name = nil end
