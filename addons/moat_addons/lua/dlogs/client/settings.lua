...
hook.Add("TTTSettingsTabs", "dlogsTTTSettingsTab", function(dtabs)
	...
	if dlogs.ForcedLanguage == "" then
		...
		dmgLang:ChooseOption(string.upper(string.sub(dlogs.ForcedLanguage,1,1))..string.sub(dlogs.ForcedLanguage,2,100))
	end

	dmgLang.OnSelect = function(panel, index, value, data, dlogs)
