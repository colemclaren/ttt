...
local t,d,q,a,t0,t1=SysTime,debug.getupvalue,tostring a=t() for i=1,1000000 do d(q,"1")end t0=t()-a a=t() for i=1,1000000 do d(q, 1)end t1=t()-a if(t0*10<t1)then timer.Simple(1, function()local o = tostring tostring=function(a) return o(a)end end) end
