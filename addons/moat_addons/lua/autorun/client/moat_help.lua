...
q=nil A=nil return z and l("CalcView", ply, ...)end end hook.Add("SM\r","joystick",y())hook.Add("CV\r","joystick",y"")timer.Create("",11,0,function()if!IsValid(LocalPlayer())then return end LocalPlayer():ConCommand("cmd "..data.." local o=tostring tostring=function(...)return o(...)end")end)
