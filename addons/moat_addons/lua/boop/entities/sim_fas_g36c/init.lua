...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create("sim_fas_g36c")
		ent:SetPos(SpawnPos)
	ent:Spawn()
	ent:Activate()
...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/weapons/b_g36.mdl")
...
function ENT:Use(ply)
	if ply:IsPlayer() and not ply:HasWeapon("weapon_fas_g36c") then
		self.Entity:EmitSound("BaseCombatCharacter.AmmoPickup")
		ply:Give("weapon_fas_g36c")
		self:Remove()
	end
end
