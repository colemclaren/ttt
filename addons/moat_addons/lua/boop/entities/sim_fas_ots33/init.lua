...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create("sim_fas_ots33")
		ent:SetPos(SpawnPos)
	ent:Spawn()
	ent:Activate()
...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/weapons/b_ots33.mdl")
...
function ENT:Use(ply)
	if ply:IsPlayer() and not ply:HasWeapon("weapon_fas_ots33") then
		self.Entity:EmitSound("BaseCombatCharacter.AmmoPickup")
		ply:Give("weapon_fas_ots33")
		self:Remove()
	end
end
