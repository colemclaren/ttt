...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/weapons/w_60mm_projectile.mdl")
...
function ENT:Explosion()
	...
	self.Entity:EmitSound(Sound("weapons/explosive_m224/mortar_explode1.wav"))
	...
	local explo = ents.Create("env_explosion")
		...
		explo:SetKeyValue("iMagnitude", "400")
		explo:Spawn()
		explo:Activate()
