...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create("sim_fas_sterlingsil")
		ent:SetPos(SpawnPos)
	ent:Spawn()
	ent:Activate()
...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/weapons/b_sterling_sil.mdl")
...
function ENT:Use(ply)
	if ply:IsPlayer() and not ply:HasWeapon("weapon_fas_sterlingsil") then
		self.Entity:EmitSound("BaseCombatCharacter.AmmoPickup")
		ply:Give("weapon_fas_sterlingsil")
		self:Remove()
	end
end
