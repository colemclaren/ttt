...
_this.chatID = "server_la"

-- Your community name
_this.communityName = "MG TTT - LA has Crashed!"
...
-- The web-based chat
-- Set this to false if you want this disabled
_this.chatURL = "http://server.moatgaming.org/acrashscreen/chat/chat.php"
...
_this.buttons = {
	...
	{ "Join TTT - #1", 'ttt.moatgaming.org' },
	{ "Join TTT - #2", 'ttt2.moatgaming.org' },
	{ "Join TTT - #3", 'ttt3.moatgaming.org' },
	{ "Join TTT - #4", '208.103.169.31:27017' },
	{ "Join TTT - MC", 'ttt-mc.moatgaming.org' },
	{ "Join TTT - MC #2", '208.103.169.31:27016' },
	{ "Join TTT - LA", 'ttt-la.moatgaming.org' },
	{ "Join TTT - EU", 'ttt-eu.moatgaming.org' }
}
