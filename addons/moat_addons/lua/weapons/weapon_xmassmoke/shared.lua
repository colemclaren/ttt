...
SWEP.Gun = ("xmas_smoke") -- must be the name of your swep but NO CAPITALS!
SWEP.Category				= "X-mas"
SWEP.Author				= "Nogitsu"
SWEP.Instructions				= ""
...
SWEP.Primary.Round 			= ("xmas_smoke_sent")	--NAME OF ENTITY GOES HERE
...
SWEP.WElements = {
	["snowman"] = { type = "Model", model = "models/roblox/bloxikin__33_snowman.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.197, 1.32, -4.724), angle = Angle(171.139, -18.907, -13.858), size = Vector(0.689, 0.689, 0.689), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.VElements = {
	["snowman"] = { type = "Model", model = "models/roblox/bloxikin__33_snowman.mdl", bone = "v_weapon.Flashbang_Parent", rel = "", pos = Vector(0.159, -0.069, 0), angle = Angle(72.924, 77.302, 0), size = Vector(0.375, 0.375, 0.375), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
