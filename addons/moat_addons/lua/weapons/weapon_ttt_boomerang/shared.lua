...
if CLIENT then
	...
	["shuriken"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 6.48, 0), angle = Angle(0, 0, 0) }

	}

	SWEP.VElements = {

	["boomerang"] = { type = "Model", model = "models/boomerang/boomerang.mdl", bone = "shuriken", rel = "", pos = Vector(1.557, 7.791, -1.558), angle = Angle(-24.546, -73.637, 92.337), size = Vector(0.69, 0.69, 0.69), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }

	}

	SWEP.WElements = {

	["boomerang"] = { type = "Model", model = "models/boomerang/boomerang.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.714, 5.714, -1.558), angle = Angle(5.843, 3.506, -82.987), size = Vector(0.69, 0.69, 0.69), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
...
function SWEP:SecondaryAttack()
		...
		else targetPos = Pos + self.Owner:GetAimVector() * 2000
