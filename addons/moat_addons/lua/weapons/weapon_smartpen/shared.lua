...
/*
SWEP.Gun = ("weapon_smartpen") -- must be the name of your swep but NO CAPITALS!
...
SWEP.Contact				= ""
SWEP.Purpose				= ""
SWEP.Instructions				= ("Write on your enemies and make sure 'they got that'.")
SWEP.PrintName				= "Pulse Smart Pen"		-- Weapon name (Shown on HUD)	
...
--]]
SWEP.WorldModel				= "models/weapons/w_psmartpen.mdl"	-- Weapon world model
...
SWEP.UseHands = false --Uses c_hands?  If you port a model directly from HL2, CS:S, etc. then set to false
...
SWEP.ViewModel				= "models/weapons/v_psmartpen.mdl"	-- Weapon view model
...
SWEP.RunSightsPos = Vector(0, 0, -8)--Blocking Position.
...
SWEP.HitRange=50 -- Blade Length.  Set slightly longer to compensate for animation.
...
SWEP.SlashDecals = 1 --The number of decals per slash.  May slightly vary
...
SWEP.Primary.Sound = ("Weapon_Pen.Swing") --Change this to your swing sound
SWEP.Primary.Sound_Impact_Flesh= ("Weapon_Pen.Hit") --Change this to your flesh hit sound
SWEP.Primary.Sound_Impact_Generic = ("Weapon_Pen.Hit") --Change this to your generic hit sound
