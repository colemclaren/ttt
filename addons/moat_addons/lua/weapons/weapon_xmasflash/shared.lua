...
SWEP.WElements = {
    ["pinguin"] = { type = "Model", model = "models/roblox/festive_penguin.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.724, 1.611, -1.818), angle = Angle(176.865, -52.213, 0), size = Vector(1.014, 1.014, 1.014), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
