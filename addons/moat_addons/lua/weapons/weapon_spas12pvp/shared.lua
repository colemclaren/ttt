...
SWEP.Contact				= ""
SWEP.Purpose				= ""
SWEP.Instructions				= "Typical shotgun with low spread."
...
SWEP.Primary.Sound			= Sound("Weapon_Spas.Fire")		-- Script that calls the primary fire sound
...
SWEP.ShellTime			= 0.40 -- For shotguns, how long it takes to insert a shell.

-- Enter iron sight info and bone mod info below

SWEP.SightsPos = Vector(-8.921, 0, -0.201)
SWEP.SightsAng = Vector(0, 0, 0)
SWEP.RunSightsPos = Vector()
SWEP.RunSightsAng = Vector()
SWEP.InspectPos = Vector(4.342, -8.747, 1.674)
...
SWEP.Primary.Delay = 0.8 + SHOTGUN_RPM_CHANGE
