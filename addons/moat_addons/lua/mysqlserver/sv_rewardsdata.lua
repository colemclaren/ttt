...
--
REWARDS.Database = {}
REWARDS.Database.Host = 'web-panel01.gmchosting.com' -- MySQL host/server IP
REWARDS.Database.Username = 'moatgaming_stats' -- MySQL username
REWARDS.Database.Password = 'mgstats' -- MySQL password
REWARDS.Database.DatabaseName = 'wdHj*443' -- MySQL database
