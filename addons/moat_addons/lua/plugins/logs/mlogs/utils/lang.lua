function mlogs.f(str, ...)
	return string.format(str, unpack({...})) or ""
end

function mlogs.s(str)
	return str
end

mlogs.str = {
	DamagedPlayer = "{attacker} has damaged	{victim} for {damage} HP{weapon}"
}
...
mlogs.stro = {
	...
	And = "and",
	VictimReportedDisconnected = "The victim or the reported player disconnected!",
	VictimDisconnected = "The victim disconnected!",
	ReportedDisconnected = "The reported player disconnected!",
	...
	dlogsMenuSettings = "dlogs menu settings",
	...
	webhook_ServerInfo = "Server: %s, Map: %s, Round: %s"
}
