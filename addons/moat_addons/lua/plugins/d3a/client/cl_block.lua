...
hook.Add("OnPlayerChat", "D3A.Chat.Block", function(pl, txt)
	if (IsValid(pl) and pl:IsValid() and IsValid(LocalPlayer()) and LocalPlayer():IsValid() and cookie.GetNumber("moat_block" .. pl:SteamID(), 0) == 1) then
		return true
	end
end)
