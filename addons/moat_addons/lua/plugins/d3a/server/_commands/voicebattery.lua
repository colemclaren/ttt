...
COMMAND.Run = function(pl, args, supp)
	...
	D3A.Chat.Broadcast2(pl, moat_teal, D3A.Commands.Name(pl), moat_white, " has ", moat_green, ((vbatenabled and "enabled") or "disabled"), moat_white, " the ", moat_green, "voice battery", moat_white, ". Changes will take effect next round.")
