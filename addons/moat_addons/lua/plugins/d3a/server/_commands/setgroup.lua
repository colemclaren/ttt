...
COMMAND.Run = function(pl, args, supp)
	...
	if (tmname == "headadmin" or tmname == "communitylead" or tmname == "owner" or tmname == "techartist" or tmname == "softwareengineer" or tmname == "gamedesigner" or tmname == "creativedirector") then
