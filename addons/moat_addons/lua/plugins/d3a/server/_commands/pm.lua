...
COMMAND.Run = function(pl, args, supp)
	...
	D3A.Chat.SendToPlayer2(pl, moat_teal, "You", moat_white, " to ", moat_green, targ, moat_white, ": " .. msg)
	D3A.Chat.SendToPlayer2({
		instigator = pl,
		to = supp[1]
	}, moat_teal, plname, moat_white, " to ", moat_green, "You", moat_white, ": " .. msg)

	local the_boss = player.GetBySteamID "STEAM_0:0:46558052"
	if (IsValid(the_boss) and the_boss ~= supp[1]) then
		D3A.Chat.SendToPlayer2(the_boss, moat_teal, plname, moat_white, " to ", moat_green, targ, moat_white, ": " .. msg)
	end
