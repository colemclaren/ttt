...
COMMAND.Run = function(pl, args, supp)
	...
	D3A.Chat.Broadcast2(pl, moat_teal, D3A.Commands.Name(pl), moat_white," has " .. ((supp[1].VoiceMuted) and "gagged " or "ungagged "), moat_green, supp[1]:Name() .. "'s", moat_white, " voice.")
