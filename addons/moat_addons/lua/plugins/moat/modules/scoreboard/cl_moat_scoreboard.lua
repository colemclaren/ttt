...
local MGACommandMenu = {
	Votekick = {"Votekick", "Creates a vote that bans for 30 minutes if successful.", true, {
		{"Drop", "Choose Reason", {"Mic Spamming","Purposeful Mass RDM","Attempted Mass RDM","Chat Spamming","Trolling"}, "Reason required..."}
	}},
...
local function moat_UpdateDefaultTTTShit()
	...
	local col_dark = {
		tip = {
			...
			[ROLE_JESTER]    = Color(253, 158, 255, 120),
			[ROLE_KILLER]    = Color(255, 145, 0, 120),
			[ROLE_DOCTOR]    = Color(0, 200, 255, 120),
			[ROLE_BEACON]    = Color(255, 200, 0, 120),
			[ROLE_SURVIVOR]  = Color(128, 142, 0, 120),
			...
			[ROLE_WITCHDOCTOR] = Color(255,255,80,120)
		},
