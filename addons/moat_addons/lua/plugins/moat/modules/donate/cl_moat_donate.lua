...
MOAT_DONATE.Packages = {{"About Beta", Material("icon16/information.png"), 1, 0, ""}, {"Free Rewards", Material("icon16/star.png"), 0, 0, ""}, 
	...
	{"10,000 IC", Material("icon16/coins.png"), 4, 1000, "", {{Color(255, 255, 0), "10,000", "Total Inventory Credits", ""}, {Color(255, 0, 255), "15", "Random Crates from the Market", ""}, {Color(255, 0, 0), "[LIMITED TIME]", "1 Easter 2020 Basket!", ""}, {Color(255, 0, 125), "", "", ""}}},
	{"25,000 IC", Material("icon16/coins.png"), 5, 2500, "3,000 Bonus", {{Color(255, 255, 0), "28,000", "Total Inventory Credits", ""}, {Color(0, 125, 255), "1", "Event Credit", ""}, {Color(255, 205, 0), "1", "Ascended Talents Mutator", ""}, {Color(255, 0, 0), "[LIMITED TIME]", "2 Easter 2020 Baskets!", ""}, {Color(255, 0, 125), "", "", ""}}}, 
	{"40,000 IC", Material("icon16/coins.png"), 6, 4000, "10,000 Bonus", {{Color(255, 255, 0), "50,000", "Total Inventory Credits", ""}, {Color(0, 125, 255), "3", "Event Credits", ""}, {Color(255, 125, 0), "1", "Rename Token", ""}, {Color(255, 205, 0), "1", "Ascended Stats Mutator", ""}, {Color(255, 0, 0), "[LIMITED TIME]", "6 Easter 2020 Baskets!", ""}, {Color(255, 0, 125), "", "", ""}}}, 
