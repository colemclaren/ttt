...
MOAT_DONATE.Packages = {{"General Information", Material("icon16/information.png"), 1, 0, ""}, {"Free Rewards", Material("icon16/star.png"), 0, 0, ""}, 
	...
	{"12,000 IC", Material("icon16/coins.png"), 5, 2000, "3,000 Bonus", {{Color(255, 255, 0), "15,000", "Total Inventory Credits", ""}, {Color(0, 125, 255), "1", "Event Credit", ""}, {Color(255, 205, 0), "1", "Ascended Stats Mutator", ""}, /*{Color(255, 0, 0), "[LIMITED TIME]", "4 Holiday Crates!", ""},*/ {Color(255, 0, 125), "", "Thank you for supporting MG <3", ""}}}, 
	{"40,000 IC", Material("icon16/coins.png"), 6, 5000, "10,000 Bonus", {{Color(255, 255, 0), "50,000", "Total Inventory Credits", ""}, {Color(0, 125, 255), "3", "Event Credits", ""}, {Color(255, 125, 0), "1", "Rename Token", ""}, {Color(255, 205, 0), "1", "Ascended Talents Mutator", ""}, /*
	{Color(255, 0, 0), "[LIMITED TIME]", "12 Holiday Crates + 1 Santa Present!", ""},*/ {Color(255, 0, 125), "", "Thank you for supporting MG <3", ""}}}, 
