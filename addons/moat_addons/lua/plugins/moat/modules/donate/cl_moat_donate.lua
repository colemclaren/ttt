...
MOAT_DONATE.Packages = {{"About Beta", Material("icon16/information.png"), 1, 0, ""}, {"Free Rewards", Material("icon16/star.png"), 0, 0, ""}, 
	...
	{"2,000 IC", Material("icon16/coins.png"), 3, 500, "500 Bonus", {{Color(255, 255, 0), "2,500", "Total Inventory Credits", ""}, {Color(255, 0, 125), "", "Thank you for supporting MG <3", ""}}}, {"5,000 IC", Material("icon16/coins.png"), 4, 1000, "1,500 Bonus", {{Color(255, 255, 0), "6,500", "Total Inventory Credits", ""}, {Color(255, 0, 255), "15", "Random Crates from the Market", ""}, {Color(255, 0, 0), "[LIMITED TIME]", "1 Easter 2020 Basket!", ""}, {Color(255, 0, 125), "", "Thank you for supporting MG <3", ""}}}, 
	{"12,000 IC", Material("icon16/coins.png"), 5, 2000, "3,000 Bonus", {{Color(255, 255, 0), "15,000", "Total Inventory Credits", ""}, {Color(0, 125, 255), "1", "Event Credit", ""}, {Color(255, 205, 0), "1", "Ascended Talents Mutator", ""}, {Color(255, 0, 0), "[LIMITED TIME]", "2 Easter 2020 Baskets!", ""}, {Color(255, 0, 125), "", "Thank you for supporting MG <3", ""}}}, 
	{"40,000 IC", Material("icon16/coins.png"), 6, 5000, "10,000 Bonus", {{Color(255, 255, 0), "50,000", "Total Inventory Credits", ""}, {Color(0, 125, 255), "3", "Event Credits", ""}, {Color(255, 125, 0), "1", "Rename Token", ""}, {Color(255, 205, 0), "1", "Ascended Stats Mutator", ""}, {Color(255, 0, 0), "[LIMITED TIME]", "6 Easter 2020 Baskets!", ""}, {Color(255, 0, 125), "", "Thank you for supporting MG <3", ""}}}, 
	{"100,000 IC", Material("icon16/coins.png"), 7, 10000, "25,000 Bonus", {{Color(255, 255, 0), "125,000", "Total Inventory Credits", ""}, {Color(0, 125, 255), "7", "Event Credits", ""}, {Color(255, 125, 0), "2", "Rename Tokens", ""}, {Color(255, 205, 0), "1", "Ascended Talents Mutator", ""}, {Color(0, 255, 0), "1", "Cosmic Stats Mutator", ""}, {Color(255, 0, 0), "[LIMITED TIME]", "15 Easter 2020 Baskets!", ""}, {Color(255, 0, 125), "", "Thank you for supporting MG <3", ""}}}, {"Dola Effect", Material("icon16/money.png"), 8, 5000, "", {{Color(255, 125, 0), "", "The Dola Effect", ""}, {Color(255, 0, 125), "", "Thank you for supporting MG <3", ""}}}, {"XP Boost", Material("icon16/star.png"), 9, 250, "", {{Color(255, 125, 0), "", "Server +300% XP Boost!", ""}, {Color(255, 0, 125), "", "Boosts 20 rounds, everybody earns +300% XP!", ""}, {Color(255, 255, 0), "", "(this is stackable)", ""}}}} --{"30 Day Star Player", Material("icon16/user_green.png"), 2000, "Stuff"}, ??? --{"1 Year Star Player", Material("icon16/user_red.png"), 20000, "Stuff"}, ??? -- MAke sure you don't take event out of name cause it's used to check if its a map event
