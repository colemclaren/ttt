...
MOAT_DONATE.Packages = {
	...
	{"40,000 IC", Material("icon16/coins.png"), 6, 4000, "10,000 Bonus", {{Color(255, 255, 0), "50,000", "Total Inventory Credits", ""}, {Color(0, 125, 255), "3", "Event Credits", ""}, {Color(255, 125, 0), "1", "Name Mutator", ""}, {Color(255, 205, 0), "1", "Ascended Stats Mutator", ""}, {Color(255, 0, 0), "[LIMITED TIME]", "6 Independence Crates!", ""}, {Color(255, 0, 125), "", "", ""}}}, 
	{"100,000 IC", Material("icon16/coins.png"), 7, 10000, "35,000 Bonus", {{Color(255, 255, 0), "135,000", "Total Inventory Credits", ""}, {Color(0, 125, 255), "7", "Event Credits", ""}, {Color(255, 125, 0), "2", "Name Mutators", ""}, {Color(255, 205, 0), "1", "Ascended Talents Mutator", ""}, {Color(0, 255, 0), "1", "Cosmic Stats Mutator", ""}, {Color(255, 0, 0), "[LIMITED TIME]", "15 Independence Crates!", ""}, {Color(255, 0, 125), "", "", ""}}},
