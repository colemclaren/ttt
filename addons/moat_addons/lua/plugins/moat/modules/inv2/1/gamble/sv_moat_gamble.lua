...
function jackpot_()
    ...
    local q = db:query("CREATE TABLE IF NOT EXISTS `moat_versus` ( `steamid` varchar(255) NOT NULL, `money` INT NOT NULL, `time` INT, `other` varchar(255), `winner` varchar(255), PRIMARY KEY (steamid) ) ")
    q:start()
    versus_curgames = {}
    versus_knowngames = {}
