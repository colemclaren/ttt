...
MOAT_THEME.Themes["Dark"] = {
    ...
    CAT_PAINT = function(s, w, h, cur_cat)
        ...
        draw.RoundedBox(0, w - 1, 0, 1, h, Color(36, 39, 44, 255))
    ...
    CATBAR_PAINT = function(s, w, h)
        ...
        draw.RoundedBox(0, (ww * s.cur_cat) - ww - 1, h - 2, ww + 1, 2, HSVToColor(s.cur_cat * 65 % 360, 1, 1))
    end,
    VBAR_PAINT = {
        PAINT = function(s, w, h)
            draw.RoundedBox(6, 0, 2, 11, h - 4, Color(36, 39, 44))
    ...
    CHAT = {
        CHAT_BG = function(s, w, h, mc, b)
            draw.RoundedBox(0, 0, 0, w, h, Color(54, 57, 62, 255 * mc.alpha))
    ...
    TradeRequest = {
        BG = function(s, w, h)
            ...
            draw.SimpleText("has requested to trade.", "GModNotify", w / 2, 195, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER)
    ...
    Crate = {
        ...
        Panel = function(s, w, h, crate_contents)
            draw.RoundedBox(0, 0, 0, w, h, Color(46, 49, 54, 255))
