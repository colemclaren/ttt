...
function m_MakeContractsPanel()
    ...
    MOAT_CONTRACTS.Paint = function(s, w, h)
        ...
        draw.SimpleTextOutlined("Contracts refresh every day, and require 6 players on your server for the kills to count.", "moat_ItemDesc", w/2, 50, Color(255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0, 35))
