...
EFFECT.Models = {}
EFFECT.Models[1] = Model("models/shells/fhell_380acp.mdl")
...
function EFFECT:Init(data)
	...
	if not IsValid(data:GetEntity()) then 
		self.Entity:SetModel("models/shells/fhell_380acp.mdl")
		self.RemoveMe = true
		return 
	end
	...
	self.Entity:SetModel(self.Models[ bullettype ] or "models/shells/fhell_380acp.mdl")
	...
	if IsValid(phys) then
		...
		phys:SetVelocity(direction * math.random(250, 500))
