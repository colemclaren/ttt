...
EFFECT.Models = {}
EFFECT.Models[1] = Model("models/shells/fhell_mc51_1st.mdl")
...
function EFFECT:Init(data)
	...
	if not IsValid(data:GetEntity()) then 
		self.Entity:SetModel("models/shells/fhell_mc51_1st.mdl")
		self.RemoveMe = true
		return 
	end
	...
	self.Entity:SetModel(self.Models[ bullettype ] or "models/shells/fhell_mc51_1st.mdl")
