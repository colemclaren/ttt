...
EFFECT.Models = {}
EFFECT.Models[1] = Model("models/shells/fhell_10mm.mdl")
...
function EFFECT:Init(data)
	...
	if not IsValid(data:GetEntity()) then 
		self.Entity:SetModel("models/shells/fhell_10mm.mdl")
		self.RemoveMe = true
		return 
	end
	...
	self.Entity:SetModel(self.Models[ bullettype ] or "models/shells/fhell_10mm.mdl")
	...
	if IsValid(phys) then
		...
		phys:SetVelocity(direction * math.random(200, 500))
