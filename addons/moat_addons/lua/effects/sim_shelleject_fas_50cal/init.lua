...
EFFECT.Models = {}
EFFECT.Models[4] = Model("models/shells/fhell_50cal.mdl")
...
function EFFECT:Init(data)
	...
	if not IsValid(data:GetEntity()) then 
		self.Entity:SetModel("models/shells/fhell_50cal.mdl")
		self.RemoveMe = true
		return 
	end
	...
	self.Entity:SetModel(self.Models[ bullettype ] or "models/shells/fhell_50cal.mdl")
	...
	if IsValid(phys) then
		...
		phys:SetVelocity(direction * math.random(-350, -650))
		phys:AddAngleVelocity((VectorRand() * 750))
