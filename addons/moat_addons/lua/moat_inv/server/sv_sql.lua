...
str = str .. "DELIMITER $$\n"
str = str .. "CREATE PROCEDURE `insertWeapon`(in uid int, in owner bigint, in slot smallint, in class varchar(32)"
str = str .. ")\n"
str = str .. "BEGIN\n"
...
for s = 1, 20 do
    ...
    str = str .. "CREATE PROCEDURE `insertWeapon" .. s .. "Stats`(in uid int, in owner bigint, in slot smallint, in class varchar(32)"
    for n = 1, s do
...
for s = 1, 20 do
    for t = 1, 20 do
        ...
        str = str .. "CREATE PROCEDURE `insertWeapon" .. s .. "Stats" .. t .. "Talents`(in uid int, in owner bigint, in slot smallint, in class varchar(32)"
        for n = 1, s do
            str = str .. ", in stat" .. n .. " char(1), in value" .. n .. " float"
        end
        for n = 1, t do
            str = str .. ", in talentid" .. n .. " smallint, in required" .. n .. " smallint, in modification" .. n .. " tinyint, in tvalue" .. n .. " float"
        end
        str = str .. ")\n"
        str = str .. "BEGIN\n"
        str = str .. "  insert into mg_items (itemid, ownerid, slotid, classname) values (uid, owner, slot, class);\n"
...
str = str .. "DELIMITER $$\n"
str = str .. "CREATE PROCEDURE `insertItemName`(in uid int, in nstr varchar(32)"
str = str .. ")\n"
str = str .. "BEGIN\n"
