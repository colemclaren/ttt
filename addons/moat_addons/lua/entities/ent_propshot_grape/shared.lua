...
ENT.MaxSize = 128
ENT.PropModels = {
	Model('models/foodnhouseholditems/grapes1.mdl'), Model('models/foodnhouseholditems/grapes2.mdl'), Model('models/foodnhouseholditems/grapes3.mdl')
}
...
function ENT:Initialize()
    ...
    self:SetTrailColor(Vector(0.9, .38, 1))
end
