...
ENT.MaxSize = 128
ENT.PropModels = {
	Model('models/foodnhouseholditems/icecream_open1.mdl'), Model('models/foodnhouseholditems/icecream_open2.mdl'), Model('models/foodnhouseholditems/icecream_open3.mdl'), Model('models/foodnhouseholditems/icecream_open4.mdl'), Model('models/foodnhouseholditems/icecream_open5.mdl'), Model('models/foodnhouseholditems/icecream_open6.mdl')
}
...
function ENT:Initialize()
    ...
    self:SetTrailColor(Vector(103/255,182/255,255/255))
end
