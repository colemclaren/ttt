...
hook.Add("HUDPaint","DamageMeme",function()
  ...
  if oldhp < LocalPlayer():Health() then oldhp = LocalPlayer():Health() end -- healing
  if oldhp > LocalPlayer():Health() then damage_m = CurTime() + 0.2; oldhp = LocalPlayer():Health() end
