...
L.tip38 = "Многие из размещаемых предметов (та��их как С4, Радио) могут быть прикреплены к стенам, используя ПКМ (правую кнопку мыши)."
