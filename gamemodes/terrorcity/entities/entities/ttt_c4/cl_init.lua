...
function ShowC4Config(bomb)
    ...
    dwires.Update = function(s, t)
        s:SetText(PT("c4_arm_attempts", {
            num = C4_WIRE_COUNT - SafeWires(t)
        }))
...
-- Wire
local PANEL = {}
local wire_colors = {Color(200, 0, 0, 255), Color(255, 255, 0, 255), Color(90, 90, 250, 255), Color(255, 255, 255, 255), Color(20, 200, 20, 255), Color(255, 160, 50, 255)}
...
function PANEL:PaintOverHovered()
    ...
    draw.SimpleText(PT("c4_disarm_cut", {
        num = self.Index
    }), "DermaDefault", 85, -10, COLOR_WHITE, 0, 0)
end
