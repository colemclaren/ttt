...
function PANEL:UpdatePlayerData()
   ...
   if (plytitle and #plytitle:Trim() > 0) then
      ...
      local col = {
         ply:GetNW2Int("MoatTitlesTitleR", 255), 
         ply:GetNW2Int("MoatTitlesTitleG", 255), 
         ply:GetNW2Int("MoatTitlesTitleB", 255)
      }
...
function PANEL:LayoutColumns()
   ...
   for k,v in ipairs(self.cols) do
      ...
      elseif ( k == 1 ) then
         ...
         if (sb_h == nil) then sb_h = v:GetTall() end
         ...
         v.PaintOver = function(s, w, h)
            ...
            if (num_mod <= 150) then surface.SetDrawColor(0, 255, 0) end

            surface.DrawRect(14, 0, 5, 15)

            if (num_mod > 150 and num_mod <= 300) then surface.SetDrawColor(255, 200, 0) end
