...
surface.CreateFont("WinHugeSmaller3", {
    font = "Trebuchet24",
    size = 56,
    weight = 1000,
    shadow = true
...
local wintitle = {
    ...
    [WIN_KILLER] = {
        txt = "hilite_win_killer",
        c = Color(255, 145, 0, 255)
    },
    [WIN_JESTER] = {
...
function CLSCORE:BuildHilitePanel(dpanel)
    ...
    if (title.txt == "hilite_win_killer") then winlbl:SetFont("WinHugeSmaller3") end
    ...
    timelbl:SetText(PT("hilite_duration", {
        time = util.SimpleTime(roundtime, "%02i:%02i")
    }))
