...
Event(EVENT_GAME, {
    ...
    icon = function(e) return app_icon, "Game" end
})
...
Event(EVENT_CREDITFOUND, {
    ...
    icon = function(e) return credit_icon, "Credit found" end
})
...
Event(EVENT_BODYFOUND, {
    ...
    icon = function(e) return magnifier_icon, "Body discovered" end
})
...
Event(EVENT_C4DISARM, {
    ...
    icon = function(e) return wrench_icon, "C4 disarm" end
})

Event(EVENT_C4EXPLODE, {
    text = function(e)
        return PT("ev_c4_boom", {
            player = e.ni
        })
    end,
    icon = function(e) return bomb_icon, "C4 exploded" end
})

Event(EVENT_C4PLANT, {
    text = function(e)
        return PT("ev_c4_plant", {
            player = e.ni
        })
    end,
    icon = function(e) return bomb_icon, "C4 planted" end
})
...
local function KillText(e)
    ...
    -- rest in that case
    if txt then return PT(txt, params) end
...
Event(EVENT_KILL, {
    text = KillText,
    icon = function(e)
        if e.att.sid == e.vic.sid or e.att.sid == -1 then return smile_icon, "Suicide" end
