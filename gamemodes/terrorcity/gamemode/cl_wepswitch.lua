...
local col_active = {
   tip = {
      ...
      [ROLE_DOCTOR]    = Color(0, 255, 255, 255),
      [ROLE_BEACON]    = Color(255, 255, 0, 255),
...
local col_dark = {
   tip = {
      ...
      [ROLE_JESTER]    = Color(253, 158, 255, 155),
      [ROLE_KILLER]    = Color(255, 145, 0, 155),
      [ROLE_DOCTOR]    = Color(0, 255, 255, 155),
      [ROLE_BEACON]    = Color(255, 255, 0, 155),
      [ROLE_SURVIVOR]  = Color(128, 142, 0, 155),
      [ROLE_HITMAN]    = Color(40, 42, 47, 155),
      [ROLE_BODYGUARD] = Color(0, 153, 153, 155),
      [ROLE_VETERAN]   = Color(179, 0, 255, 155),
      [ROLE_XENOMORPH] = Color(0, 249, 199, 155)
   },
...
surface.CreateFont("TimeLeftSmall",     {font = "Trebuchet24",
                                    size = 20,
                                    weight = 800})
